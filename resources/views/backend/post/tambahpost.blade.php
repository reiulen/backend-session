            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form id="formtambah" action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="">
                        @csrf
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="text" class="form-control inputtags" value="{{ old('tag') }}" name="tag">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            <div class="col-sm-12 col-md-10 mx-auto">
                               <textarea name="content"  id="summernote" class="form-control @error('content') is-invalid  @enderror " required autofocus></textarea>
                               @error('content')
                                <div class="invalid-feedback ">
                                    Content {{ $message }}
                                </div>
                       ...
                       <div class="form-group row my-4">
                            ...
                            <div class="col-sm-12 col-md-6 text-center">
                                <button type="button" onclick="document.getElementById('formtambah').submit()" class="btn btn-dark col-5">Tambah</button>
                            </div>
                        </div>
                    </form>
                  </div>
