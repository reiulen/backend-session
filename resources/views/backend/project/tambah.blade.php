            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form id="formtambah" action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="">
                        @csrf
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="text" name="deskripsi" value="{{ old('deskripsi')  }}" class="form-control @error('deskripsi') is-invalid  @enderror" required autofocus>
                               @error('deskripsi')
                                <div class="invalid-feedback ">
                                    Deskripsi {{ $message }}
                                </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="text" name="link" value="{{ old('link')  }}" class="form-control @error('link') is-invalid  @enderror" required autofocus>
                               @error('link')
                                <div class="invalid-feedback ">
                                    Link {{ $message }}
                                </div>
