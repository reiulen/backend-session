            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form  action="{{ route('anggota.update', $user->id ) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="">
                        @method('put')
                        @csrf
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Avatar</label>
                            <div class="col-md-4">
                                <img src="{{ asset($user->avatar); }}" class="img-fluid img-preview">
                                @error('avatar')
                                    Gambar {{ $message }}
                                @enderror
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="number" name="nis" value="{{ (old('nis') ? old('nis') : $user->nis)  }}" class="form-control @error('nis') is-invalid  @enderror" required autofocus>
                               @error('nis')
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="text" name="nama" value="{{ (old('nama') ? old('nama') : $user->nama)  }}" class="form-control @error('nama') is-invalid  @enderror" required autofocus>
                               @error('nama')
                                <div class="invalid-feedback ">
                                    Nama {{ $message }}
                                </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="email" name="email" value="{{ (old('email') ? old('email') : $user->email)  }}" class="form-control @error('email') is-invalid  @enderror" required autofocus>
                               @error('email')
                                <div class="invalid-feedback ">
                                    Email {{ $message }}
                                </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="password" name="password1" value="{{ old('password1')  }}" class="form-control @error('password1') is-invalid  @enderror" >
                               @error('password1')
                                <div class="invalid-feedback ">
                                    Password {{ $message }}
                                </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <input type="password" name="password2" value="{{ old('password2')  }}" class="form-control @error('password2') is-invalid  @enderror" >
                               @error('password2')
                                <div class="invalid-feedback ">
                                    Password {{ $message }}
                                </div>
